...
For concrete information on the minimum required versions, check [meson.build](https://gitlab.xfce.org/panel-plugins/xfce4-clipman-plugin/-/blob/master/meson.build).
